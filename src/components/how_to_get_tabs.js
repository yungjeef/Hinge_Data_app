          ...
          <TabContext value={value}>
            <Box sx={{ borderBottom: 1, borderColor: 'divider'}}>
              <TabList 
                ...
                >
                <Tab label="Hinge" value="1" sx={{color:'white', width:200}}/>
                <Tab label="Tinder" value="2" sx={{color:'white', width:200}}/>
                <Tab label="Coffee Meets Bagel" value="3" sx={{color:'white', width:200}}/>
                <Tab label="Bumble" value="4" sx={{color:'white', width:200}}/>
              </TabList>
            </Box>
            <TabPanel value="1">
